...
int main() {
  ...
  char arr[] = {'a', 'b', 'c'};
  cout << arr
       << endl; // abc or abc+some garbage if box contains null in the end
  // hence right way is :
  char ar[] = {'a', 'b', '\0'};
  cout << ar << endl;
  ...
  // cin.getline(array, size, delimiter)  // delimiter tells when to stop
  // reading by default deliminiter is \n
  char c[100];
  cin.getline(c, 100);
  cout << c << endl;
